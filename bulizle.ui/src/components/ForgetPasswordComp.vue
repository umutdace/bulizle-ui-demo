                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-9 col-lg-8 mx-auto">
                                <h3 class="login-heading mb-4">E-posta Adresinizi girerek şifre değiştirme bağlantınızı
                                    alabilirsiniz!</h3>
                                ...
                                <form>
                                    ...
                                    <div class="d-grid">
                                        <button class="btn btn-lg btn-primary btn-login text-uppercase fw-bold mb-2"
                                            type="button" @click="ForgetPassword()">Gönder</button>
                                    </div>
...
export default {
    ...
    methods: {
        ForgetPassword() {
            ...
            fetch(this.baseUrl + "api/ForgetPassword?email=" + this.email.val, {
                method: "POST",
                headers: {
                ...
                if (!data.isSuccess)
                    ...
                    this.ShowSuccessWithLocation("Başarılı!", "E-posta adresine gönderdiğimiz bağlantıdan şifreni değiştirebilirsin.", "/");
                }
            }).catch(() => {
                this.ShowError(
                    "Hata / Error",
