<template>
    <div class="container">
        <div class="item item-1" v-for="index in contents" :key="index.id" :name="index.title" @click="this.ShowMoreInfo(index.name,index.summary,index.fragmanUrl,index.link)" 
        :style="{ 'background-image': 'url(' + index.image + ')' }">
            <div class="body-item">
