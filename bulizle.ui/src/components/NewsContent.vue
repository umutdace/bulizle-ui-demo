<template>  
    ...
    <div class="blog-container" v-for="index in news" :key="index.id" :name="index.title">
        <div class="blog-header">
            <div class="blog-cover" :style="{ 'background-image': 'url(' + index.image + ')' }">
            </div>
        </div>
        <div class="blog-body">
            <div class="blog-title">
                <h3><a target="_blank" :href="index.link">{{ index.name }}</a></h3>
            </div>
        ...
        <div class="blog-footer">
            <div class="blog-tags">
                <ul>
                    <li><a target="_blank" :href="index.link">HABER'E GİT</a></li>
                </ul>
            </div>
        </div>
