        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <input type="submit" value="Kaydet" @click="UpdateContent()" class="btn btn-success float-right">
                </div>
            </div>
        </section>
    </div>
...
export default {
    ...
    created() {
        ...
        fetch(this.baseUrl + "api/GetContent?id="+this.content.id, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    methods: {
        UpdateContent() {
            var data = {
                ...
                fragmanUrl: this.content.fragmanUrl,
                image: this.content.image,
                series: this.content.series,
                categoryId: this.content.categoryId,
                platformId: this.content.platformId,
            }
